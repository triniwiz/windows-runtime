...
use rusty_v8 as v8;
use bindings::{Windows::Win32::System::Console,Windows::Win32::System::WindowsProgramming};
...
pub(crate) fn handle_console_log(scope: &mut v8::HandleScope, args: v8::FunctionCallbackArguments, _retval: v8::ReturnValue){
    ...
    unsafe {
        Console::WriteConsoleA(handle, string.as_ptr() as *const c_void, length, &mut written, std::ptr::null_mut());
    }
