...
pub static KNOWN_FNS: &[KnownFn] = &[
    ...
    KnownFn {
        ...
        name: "VirtualAlloc",
        ret: "pointer",
        params: &["pointer", "u64", "u32", "u32"],
    },
    KnownFn {
        dll: "kernel32.dll",
        name: "VirtualFree",
        ret: "bool",
        params: &["pointer", "u64", "u32"],
    },
    KnownFn {
        dll: "kernel32.dll",
        name: "CreateEventW",
        ret: "pointer",
        params: &["pointer", "bool", "bool", "pointer"],
    },
    KnownFn {
        dll: "kernel32.dll",
        name: "SetEvent",
    ...
    KnownFn {
        ...
        name: "keybd_event",
        ret: "void",
        params: &["u8", "u8", "u32", "u64"],
    },
    KnownFn {
        dll: "user32.dll",
        name: "mouse_event",
        ret: "void",
        params: &["u32", "i32", "i32", "u32", "u64"],
    },
    KnownFn {
        dll: "user32.dll",
        name: "ClipCursor",
    ...
    KnownFn {
        ...
        name: "MoveWindow",
        ret: "bool",
        params: &["pointer", "i32", "i32", "i32", "i32", "bool"],
    },
    KnownFn {
        dll: "user32.dll",
        name: "InvalidateRect",
    ...
    KnownFn {
        ...
        name: "mciSendStringW",
        ret: "u32",
        params: &["wstr", "pointer", "u32", "pointer"],
    },
    KnownFn {
        dll: "gdi32.dll",
        name: "GetDeviceCaps",
    ...
    KnownFn {
        ...
        name: "ShellExecuteW",
        ret: "pointer",
        params: &["pointer", "wstr", "wstr", "wstr", "wstr", "i32"],
    },
    KnownFn {
        dll: "shell32.dll",
        name: "SHGetFolderPathW",
        ret: "i32",
        params: &["pointer", "i32", "pointer", "u32", "pointer"],
    },
    KnownFn {
        dll: "advapi32.dll",
        name: "RegOpenKeyExW",
        ret: "i32",
        params: &["pointer", "wstr", "u32", "u32", "pointer"],
    },
    KnownFn {
        dll: "advapi32.dll",
        ...
        ret: "i32",
        params: &[
            "pointer", "wstr", "pointer", "pointer", "pointer", "pointer",
        ],
    },
    KnownFn {
        dll: "advapi32.dll",
    ...
    KnownFn {
        ...
        ret: "bool",
        params: &["pointer", "pointer", "u32"],
    },
    KnownFn {
        dll: "kernel32.dll",
        name: "K32GetProcessMemoryInfo",
        ret: "bool",
        params: &["pointer", "pointer", "u32"],
    },
];
...
pub fn lookup(dll: &str, name: &str) -> Option<&'static KnownFn> {
    KNOWN_FNS
        .iter()
        .find(|f| f.name == name && f.dll.eq_ignore_ascii_case(dll))
}
