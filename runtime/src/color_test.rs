...
fn test_logging_windows_ui_color_does_not_panic() {
    ...
    runtime.run_script("console.log('red', Windows.UI.ColorHelper.FromArgb(255, 255, 0, 0));", "color_fromargb_test.js");

    // Static color property (predefined struct value)
    runtime.run_script("console.log('green', Windows.UI.Colors.Green);", "color_static_green_test.js");
