...
#ifndef WINDOWS_RUNTIME_V8_NETWORK_AGENT_IMPL_H
#define WINDOWS_RUNTIME_V8_NETWORK_AGENT_IMPL_H
...
namespace v8_inspector {
    ...
    public:
        ...
        DispatchResponse enable(Maybe<int> in_maxTotalBufferSize, Maybe<int> in_maxResourceBufferSize,
                                Maybe<int> in_maxPostDataSize) override;
        ...
        DispatchResponse emulateNetworkConditions(bool in_offline, double in_latency, double in_downloadThroughput,
                                                  double in_uploadThroughput, Maybe<String> in_connectionType) override;

        DispatchResponse
        getCertificate(const String &in_origin, std::unique_ptr <protocol::Array<String>> *out_tableNames) override;

        void
        getRequestPostData(const String &in_requestId, std::unique_ptr <GetRequestPostDataCallback> callback) override;

        DispatchResponse replayXHR(const String &in_requestId) override;

        DispatchResponse
        searchInResponseBody(const String &in_requestId, const String &in_query, Maybe<bool> in_caseSensitive,
...
#endif //WINDOWS_RUNTIME_V8_NETWORK_AGENT_IMPL_H
