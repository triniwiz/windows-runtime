...
#ifndef WINDOWS_RUNTIME_V8_OVERLAY_AGENT_IMPL_H
#define WINDOWS_RUNTIME_V8_OVERLAY_AGENT_IMPL_H
...
namespace v8_inspector {
    ...
    public:
        ...
        DispatchResponse getHighlightObjectForTest(int in_nodeId,
                                                   Maybe<bool> in_includeDistance, Maybe<bool> in_includeStyle,
...
#endif //WINDOWS_RUNTIME_V8_OVERLAY_AGENT_IMPL_H
