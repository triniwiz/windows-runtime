...
namespace v8_inspector {
    ...
    void
    V8LogAgentImpl::EntryAdded(const std::string &text, std::string verbosityLevel, std::string url, int lineNumber) {
    ...
    DispatchResponse V8LogAgentImpl::startViolationsReport(
