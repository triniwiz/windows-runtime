...
namespace org {
	namespace nativescript {
		...
		private:
            static void
                AttachLogFunction(v8::Local <v8::Context> context, v8::Local <v8::Object> console, const std::string name,
            ...
            static std::string
                BuildStringFromArgs(const v8::FunctionCallbackInfo <v8::Value>& args, int startingIndex = 0);

            static const v8::Local <v8::String>
                BuildStringFromArg(v8::Local <v8::Context> context, const v8::Local <v8::Value>& val);
