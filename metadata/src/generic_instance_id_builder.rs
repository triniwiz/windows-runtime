...
use windows::Win32::System::WinRT::Metadata::{IRoMetaDataLocator, RoGetParameterizedTypeInstanceIID, RoParseTypeName};
...
impl GenericInstanceIdBuilder {
    extern "system" fn locator_impl(this:*mut c_void, name: PCWSTR, dest: *mut c_void) -> HRESULT {
    ...
    pub fn generate_id(declaration: &dyn Declaration) -> GUID {
        ...
        let result = unsafe { RoGetParameterizedTypeInstanceIID(buf.as_slice(), GenericInstanceIdBuilder::locator_impl, &mut guid, None) };
