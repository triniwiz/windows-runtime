...
struct napi_env__ {
  explicit napi_env__(v8::Local<v8::Context> context,
      ...
      : isolate(v8::Isolate::GetCurrent()), // [windows port] V8 14.7 removed Context::GetIsolate()
  ...
  // have such a callback. See `NapiEnvironmentnment()` above for details.
