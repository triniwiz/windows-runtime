...
// [windows port] cl rejects GCC attribute syntax; dllexport so the statically-linked shim's
// napi_* are found by napi-sys's GetProcAddress(exe) lookup (same as the quickjs/jsc packages).
#ifdef _WIN32
